...
const Login = ({ navigation }) => {
  ...
  const persistLogin = (credentials, message, status) => {
    AsyncStorage.setItem('PawCareCredentials', JSON.stringify(credentials))
      .then(() => {
        handleMessage(message, status);
  ...
  return (
    <KeyboardAvoidingWrapper>
      <StyledContainer>
        ...
        <InnerContainer>
          <PageLogo resizeMode="cover" source={require('./../assets/img/expo-logo.png')} />
          <PageTitle>PawCare</PageTitle>
